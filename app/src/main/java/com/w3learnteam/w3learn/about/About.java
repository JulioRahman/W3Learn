    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                creatorsListDefault.animate().scaleY(1).scaleX(1).setDuration(550).
                        setInterpolator(new AccelerateInterpolator()).start();

                LinearLayout creatorsJobBGDefault = viewHolderDefault.itemView.
                        findViewById(R.id.creatorsjobbg);
                creatorsJobBGDefault.animate().alpha(1).setDuration(500).start();
       ...
       Creation.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE){
                    ...
                    creatorlist.animate().scaleY(1).scaleX(1).setDuration(350).
                            setInterpolator(new AccelerateInterpolator()).start();

                    LinearLayout creatorjobbg = viewHolder.itemView.
                            findViewById(R.id.creatorsjobbg);
                    creatorjobbg.animate().alpha(1).setDuration(300).start();
                    ...
                    LinearLayout creatorjobbg = viewHolder.itemView.
                            findViewById(R.id.creatorsjobbg);
                    creatorjobbg.animate().alpha(0).setDuration(300).start();
                }
            }
